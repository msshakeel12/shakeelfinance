...
(function() {  
  ...
  css.type = "text/css";
  css.innerHTML = ".pts-rect { font-size: 20vw; line-height: 50vh; overflow: hidden; } .r2 { opacity: 0.9 } .r1a { border-bottom-color: #fff !important; }";
  ...
  space.add(
    ...
    function (time, ftime) {
      ...
      document.querySelector(".r1").textContent = "Vote";
      document.querySelector(".r1a").textContent = "Vote";

      // Draw second rectange
      form.fillOnly("#f03").fillText("#fff").cls("r2").rect( r2 );
      document.querySelector(".r2").textContent = "Shakeel";
    }
  );
